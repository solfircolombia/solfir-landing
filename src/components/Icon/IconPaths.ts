...
// Using paths from https://mui.com/material-ui/material-icons to keep them consistent; look for viewbox="0 0 24 24" icons
const IconPath: Record<IconName, string> = {
    ...
    "arrow-right": "m12 4-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z",
    "menu": "M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z",
    "close": "M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"
}

export { IconPath, IconName }