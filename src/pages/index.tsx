        ...
        <section className={`${BASE_CLASS}-banner`} id={`${BASE_CLASS}-banner`}>
          <div className={`${BASE_CLASS}-wrapper`}>
            <span className={`${BASE_CLASS}-banner-title`}>
              ...
              <b className={`${BASE_CLASS}-banner-title-solfir`}>SOLFIR</b> expertos en insolvencia
                ...
                return (
                  <div key={idx} className="service-box">
                    <div className="service-box-content">
                      ...
                      <div className="service-box-content-text">{serviceText}</div>
                    </div>
                  </div>
                );
              })}
        ...
        <section className={`${BASE_CLASS}-blog`}>
          <div className={`${BASE_CLASS}-wrapper`}>
            ...
            <p className={`${BASE_CLASS}-blog-text`}>
              ...
              para ayudarte a manejar mejor tus finanzas personales o empresariales. Además, te
              mantendremos informado sobre temas de actualidad relacionados con la insolvencia y
              otras cuestiones legales y financieras relevantes.
            </p>
        ...
        <section className={`${BASE_CLASS}-hireus`}>
          <div className={`${BASE_CLASS}-wrapper`}>
            ...
            <p className={`${BASE_CLASS}-hireus-text`}>
              Con un equipo de expertos dedicados y años de experiencia, nos aseguramos de brindar
              soluciones óptimas para cada situación única. Contáctanos hoy para ver cómo podemos
              ayudarte a lograr la estabilidad financiera.
            </p>
            <Button
              variant="light"
