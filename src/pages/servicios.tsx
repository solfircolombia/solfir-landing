            ...
            <div className={BASE_CLASS}>
                <div className={`${BASE_CLASS}-wrapper`} >
                    <div className={`${BASE_CLASS}-message-box`} >
                        ...
                        <span className={`${BASE_CLASS}-message-box-text`} >Esta pagina aun se encuentra en construcción</span>
...
export const Head: HeadFC = () => <title>SOLFIR - {STATIC_SITE_LABELS.SERVICES}</title>