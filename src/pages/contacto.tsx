            ...
            <div className={BASE_CLASS}>
                ...
                <div className={`${BASE_CLASS}-header`}>
                    <div className={`${BASE_CLASS}-wrapper`}>
                        <h1>¿Necesitas una consulta?<br />Envianos un mensaje</h1>
                    </div>
                </div>
                    ...
                    <div className={`${BASE_CLASS}-wrapper`}>
                        <div className={`${BASE_CLASS}-form-box`}>
                            <form className={`${BASE_CLASS}-form-box-form`} action="/api/sendgrid" method="POST">
                                <span className={`${BASE_CLASS}-form-box-title`}>Por favor ingrese los siguientes datos</span>
                                ...
                                <div className={`${BASE_CLASS}-form-box-form-group`} >
                                    <Button className={`${BASE_CLASS}-form-box-form-group-submit`} type='submit' variant='secondary' >Enviar Mensaje</Button>
                                </div>
                            </form>
                        </div>
