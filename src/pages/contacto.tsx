        ...
        <div className={`${BASE_CLASS}-form-section`}>
          <div className={`${BASE_CLASS}-wrapper`}>
            <div className={`${BASE_CLASS}-form-box`}>
              <form className={`${BASE_CLASS}-form-box-form`} action="/api/sendgrid" method="POST">
                <span className={`${BASE_CLASS}-form-box-title`}>
                  Por favor ingrese los siguientes datos
                </span>
                <div className={`${BASE_CLASS}-form-box-form-group`}>
                  <label className={`${BASE_CLASS}-form-box-form-group-label`} htmlFor="name">
                    Nombre:
                  </label>
                  <input
                ...
                <div className={`${BASE_CLASS}-form-box-form-group`}>
                  <label className={`${BASE_CLASS}-form-box-form-group-label`} htmlFor="phone">
                ...
                <div className={`${BASE_CLASS}-form-box-form-group`}>
                  <label className={`${BASE_CLASS}-form-box-form-group-label`} htmlFor="email">
                ...
                <div className={`${BASE_CLASS}-form-box-form-group`}>
                  <label className={`${BASE_CLASS}-form-box-form-group-label`} htmlFor="subject">
                ...
                <div className={`${BASE_CLASS}-form-box-form-group`}>
                  <label className={`${BASE_CLASS}-form-box-form-group-label`} htmlFor="text">
                    Mensaje:
                  </label>
                  <textarea
